...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9eb1f4b6fc463e40959215d2834f0559) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Glicko2"; "Glicko2_types"];
                      lib_pack = false;
                      lib_internal_modules =
                        ["Glicko_internal"; "InternalLogs"; "Default_values"];
     ...
     oasis_digest = Some "}\186_\181!O31\202\129\144\207\237\239\2271";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
