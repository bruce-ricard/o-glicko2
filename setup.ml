...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4b0276d9a1d9fb21ab8c834bcad7c81f) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("logs", None)];
                      bs_build_tools =
                   ...
                   },
                   {
                      lib_modules = ["Glicko2"];
                      lib_pack = false;
                      lib_internal_modules = ["Glicko_internal"];
     ...
     oasis_digest = Some "\208\003m6\239$\163\203\217`\133W\248\006*E";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
